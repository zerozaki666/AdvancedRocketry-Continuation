...
public class TextureResources {
	...
	public static final ResourceLocation locationBlackHole =
			new ResourceLocation("advancedrocketry:textures/env/blackhole.png");
	public static final ResourceLocation locationAccretionDisk =
			new ResourceLocation("advancedrocketry:textures/env/accretiondisk.png");
	public static final ResourceLocation locationBlackHoleIcon =
			new ResourceLocation("advancedrocketry:textures/env/blackhole_icon.png");
