...
public final class AdvancedRocketryUniverse {
	...
	private static final class SimStar implements ISimStellar {
		...
		@Override public double getMass() { return Math.max(star.getMass(), 0.01F); }
	...
	private static final class SimPlanet implements ISimStellar {
